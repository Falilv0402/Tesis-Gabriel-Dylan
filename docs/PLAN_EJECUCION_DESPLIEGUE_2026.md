...
- [ ] **Pendiente**: borrar del alumno real los hitos de prueba creados durante la verificación (Mori Romayna, Paredes Herrera) y las filas de `plan_estado`/`notificaciones` de prueba, y las 3 cuentas de prueba (`testpdf@upc.edu.pe`, `test.respaldo@upc.edu.pe`, `test.coord.plan@upc.edu.pe`).
