...
- [ ] **Pendiente**: migración `0016` sin aplicar en Supabase. Sin ella, el Director ve la pestaña "Usuarios" pero el cambio de rol falla por RLS.
- [ ] **Pendiente (a discutir con Mathias)**: lista de brechas "abogado del diablo" — ver mensaje del 2026-09-10 en el chat con Claude para las recomendaciones que todavía no se implementaron (requieren decisión de alcance).
