...
- [ ] **Nota de alcance honesta**: con esto, el flujo de aprobación de planes queda 100% documentado. Pero al construirlo se confirmó que las funcionalidades BASE de "Anotaciones" y "Plan de hitos" (existen y funcionan desde antes de esta sesión) nunca tuvieron su propia HU — son un hueco previo a hoy, no algo que estos cambios hayan creado. Si se quiere que el excel sea 100% fiel a TODA la app (no solo a lo tocado hoy), falta documentarlas.
