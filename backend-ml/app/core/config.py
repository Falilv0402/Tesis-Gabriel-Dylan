...
class Settings(BaseSettings):
    ...
    # Clave para proteger endpoints mutantes (reentrenamiento, procesamiento de archivos)
    # Se lee de la variable de entorno SATRA_API_KEY; si no está definida, no se exige (dev local).
    satra_api_key: str = ""
